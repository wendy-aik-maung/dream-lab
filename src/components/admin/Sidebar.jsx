...
const Sidebar = () => {
  ...
  return (
    <div className="h-screen flex flex-col w-80 items-center py-8 bg-dreamLabColor4 text-white text-opacity-50">
      ...
      <div className="flex flex-col">
        ...
        {manage && (
          <div>
            ...
            <AdminSidebarLink to="/banner" icon={<BiImage />} title="Banner" />
            <AdminSidebarLink
              to="/"
        ...
        {subscription && (
          <div>
            <AdminSidebarLink to="/" icon={<FaUserAlt />} title="Subscriber" />
          </div>
        )}
      </div>
    </div>
